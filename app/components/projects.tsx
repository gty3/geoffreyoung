...
const GithubButton = ({ github }: { github: string }) => {
  ...
  return (
    <div
      ...
      className="z-30 flex items-center justify-center w-40 px-5 py-2 space-x-2 transition-all bg-white border border-gray-300 rounded-full shadow-lg hover:border-gray-800"
    >
