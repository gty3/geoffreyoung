...
Created time: September 14, 2022 8:45 AM
Last edit: October 11, 2022 12:27 PM

Note: I have abandoned this post as I moved my image processing to outside providers. 
...
![Untitled](How%20to%20upload%20images%20to%20S3%20using%20Quill,%20React,%20and%2070e200c77af1472fabca26238c0da1a8/Untitled.png)
...
![createIdentity.png](How%20to%20upload%20images%20to%20S3%20using%20Quill,%20React,%20and%2070e200c77af1472fabca26238c0da1a8/createIdentity.png)
...
Now let's display those images using a serverless image handler: [Retrieving images from S3](https://notetree.me/gty/retrieve-images-from-s3-using-awss-serverless-image-handler).